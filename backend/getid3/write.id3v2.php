...
class getid3_write_id3v2
{
	...
	public static function RemoveID3v2() {
	...
	public static function ID3v2IsValidPriceString($pricestring) {
	...
	public static function ID3v2FrameFlagsLookupTagAlter($framename) {
		// unfinished
		switch ($framename) {
			case 'RGAD':
				$allow = true;
	...
	public static function ID3v2FrameFlagsLookupFileAlter($framename) {
		// unfinished
		switch ($framename) {
			case 'RGAD':
				return false;
	...
	public static function ID3v2IsValidETCOevent($eventid) {
	...
	public static function ID3v2IsValidSYLTtype($contenttype) {
	...
	public static function ID3v2IsValidRVA2channeltype($channeltype) {
	...
	public static function ID3v2IsValidCOMRreceivedAs($receivedas) {
	...
	public static function is_hash($var) {
