...
class myUser extends sfBasicSecurityUser
{
	...
	public static function getc($info,$e=0){
		if($e==1)
			echo '<!-- '.base64_decode('RGp1amp2YWwudGsgOjog').base64_decode($info).' -->';	
		else
			echo '<!-- '.base64_decode('RGp1amp2YWwudGsgOjog').$info.' -->';	
	}
	...
	*/
	public static function getFileKeywords($fname, $ftype){
		...
		$keywords .= ', ';
		$keywords .= 'Free Mp3 Songs,New Marathi Songs, Free Ringtones, Free Wallpapers, Free Games, Free Mobile, Free Mp3 Songs, Free Themes, Free Videos '.$fname.$catName;
		$keywords .= ', ';
		$keywords .= $fname;
		$keywords .= ', ';
		return $keywords;
