...
class categoryActions extends sfActions
{
  ...
  public function executeList()
  {
  	...
  	if($this->getRequestParameter('parent')){
	    ...
	    $this->getResponse()->setTitle($this->catName .' djmaza.info, waploft.com, freshmaza.info. pagalworld.com. mastiway.com. songspk.name, hungama.com, itunes. saavn.com, gaana.com, youtube.com, videoming.in, mymp3song.com, mobway.in, mobboss.in, djgol.com, djgoogle.in, djgol.com, mirchifun.com, fullmp3.in, videoking.in, songscloud.in, mobihd.in, MobiMasti.in, mobimastimp4.com '.$parent->title.' '.substr($this->catTitle,0,-2).' :: '.sfConfig::get('app_sitename').'');
	    unset($this->catTitle);
