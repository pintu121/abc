...
<tr>
	<th>Thumb display:</th>
	<td><?php
		if(is_file(sfConfig::get('sf_upload_dir').'/thumb/c/'.$category->getId().'_4.jpg')){
			echo '<div id="thumbUpdate">'.
			image_tag(sfConfig::get('app_upload_dir').'/thumb/c/'.$category->getId().'_1.jpg').'&nbsp;'.
			image_tag(sfConfig::get('app_upload_dir').'/thumb/c/'.$category->getId().'_2.jpg').'&nbsp;'.
			image_tag(sfConfig::get('app_upload_dir').'/thumb/c/'.$category->getId().'_3.jpg').'&nbsp;'.
			image_tag(sfConfig::get('app_upload_dir').'/thumb/c/'.$category->getId().'_4.jpg').'&nbsp;'.
			link_to('original',sfConfig::get('app_upload_dir').'/thumb/c/'.$category->getId().'_0.jpg').
			'</div>';
		}
