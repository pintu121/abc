...
class dirCatchAction extends sfAction
{
  public function execute()
  {
  	...
  	elseif($this->getRequestParameter('dir_path')){
	    ...
	    if( $dh = opendir($dir))
	    {
	        while( false !== ($file = readdir($dh)))
	        {
	            ...
	            elseif(is_file($path)){
	                $files[str_replace($replaceText,'',$file)] = base64_encode(str_replace($_SERVER['DOCUMENT_ROOT'],'http://'.$_SERVER['HTTP_HOST'], str_replace(' ','%20',$path)));
	...
	if($this->getRequestParameter('commit')=='show files Z-A'){
  	...
  	//$files = array(base64_encode('http://kingmarathi.com/siteuploads/files/sfd26/12626/Toyota%20Ad%20Music%203(kingmarathi.com).mp3'), base64_encode('http://thumb.kingmarathi.com/ts80/mid_39563.jpg'),base64_encode('http://thumb.kingmarathi.com/ts80/mid_39561.jpg'));
  	//$rename_file_name = array(base64_encode('toyota ad.mp3'),base64_encode('mid_39563.jpg'),base64_encode('mid_39561.jpg'));
	 	$this->dirs = $dirs;
