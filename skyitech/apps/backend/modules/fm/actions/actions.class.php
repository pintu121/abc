...
class fmActions extends sfActions
{
  public function executeIndex()
  {
  	...
  	if(!$this->getRequestParameter('dir_path') || !preg_match('/^\/junction/i',$this->getRequestParameter('dir_path')))
 			$this->dir_path = '/junction';
  	else
		...
		if($this->getRequestParameter('file'))
  		{
		  	...
		  	if(preg_match('/\/junction\//i',$pathToDelete))
		...
		if($this->getRequestParameter('file'))
  		{
		  	...
		  	if(is_dir($pathToRename) || is_file($pathToRename))
			  	if(preg_match('/\/junction\//i',$pathToRename))
