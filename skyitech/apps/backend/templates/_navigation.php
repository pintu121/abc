		<div class="navigation">
			...
			<?php
				if($sf_user->isAuthenticated() && $sf_user->hasCredential('admin')){
			...
			<div class="otherLinks">
				<?php 
					//echo link_to('Other','#',array('onClick'=>'if(document.getElementById(\'otherLinks\').style.display=="none") document.getElementById(\'otherLinks\').style.display="block"; else document.getElementById(\'otherLinks\').style.display="none";return false;'));
					echo link_to('Other','#',array('id'=>'otherLink'));
					?>
				<ul id="otherLinks" style="">
					<li><?php echo link_to('File Manager', '/fm/index', array()); ?></li>
					<li><?php echo link_to('Advertisement', '/advt', array()); ?></li>
					<li><?php echo link_to('Setting', '/setting/list', array()); ?></li>	
					<li><?php echo link_to('Change Password', '/setting/changePassword', array()); ?></li>	
				</ul>
			</div>
			<div class="online">
				<span id="online"></span>
