...
abstract class BaseAdminPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (AdminPeer::ID, AdminPeer::USERNAME, AdminPeer::PASSWORD, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (AdminPeer::ID => 0, AdminPeer::USERNAME => 1, AdminPeer::PASSWORD => 2, ),
	...
	{
		include_once 'lib/model/map/AdminMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.AdminMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/AdminMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.AdminMapBuilder');
}
